...
//depure o código abaixo
  //kangaroo.x=camera.position.x-270;
   //kangaroox=camera.position.x-270;
    //kangaroo.XY=camera.position.x-270;
  if (gameState===PLAY){
...
//encontre o bug no código abaixo
    var rub = createSprite(camera.position.x +500,330,40,10);
    ...
    //encontre o bug no código abaixo
    switch(rand) {
      case 1: shrub.adImage(shrub1);
      case 2: shrub.addimage(shrub2);
      case 3: shrub.addImage(shrub2);
      default: break;
    }
